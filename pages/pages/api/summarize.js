// Tell Vercel to allow up to 4mb request bodies
export const config = {
  api: {
    bodyParser: {
      sizeLimit: "4mb",
...
export default async function handler(req, res) {
  ...
  let { bookText, summaryType } = req.body;

  // Trim text to max 8000 characters before processing — enough for great summaries
  if (bookText && bookText.length > 8000) {
    bookText = bookText.slice(0, 8000);
  }
